...
image: /blog-photos/storybook-cms.webp
imageAlt: Contenful CMS loves Storybook
summary: A CLI utility that syncs Storybook files to Contenful CMS giving designers the ability to directly contribute to Storybook documentation.
